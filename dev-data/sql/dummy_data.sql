CREATE DATABASE IF NOT EXISTS `routinder`
...
INSERT INTO
  `sticker`
VALUES
  (1, 'red', 'https://i.imgur.com/hfWvR6S.png'),(2, 'blue', 'https://i.imgur.com/yvAjmbi.png'),(3, 'yellow', 'https://i.imgur.com/57HW19I.png');
...
CREATE TABLE `sticker_stamp` (
    ...
    CONSTRAINT `sticker_stamp_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`id`),
    CONSTRAINT `sticker_stamp_ibfk_2` FOREIGN KEY (`routineId`) REFERENCES `routine` (`id`)
...
VALUES
  (
    ...
    '2021-04-02 00:00:00',
    '2021-04-02 17:00:00'
  ),(2, 1, 1, 0, '2021-04-03 00:00:00', NULL);
